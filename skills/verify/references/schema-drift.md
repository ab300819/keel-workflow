...
|---|---|---|
| `docs/devdocs/01-requirements.md`（含拆分文件） | ms-requirements | `skills/requirements/references/realign.md` |
| `docs/devdocs/02-system-design*.md` | ms-system-design | `skills/system-design/references/realign.md` |
...
- ms-sync 的 health report 可选择性合并 drift 列（权重低，见 `skills/sync/`）
