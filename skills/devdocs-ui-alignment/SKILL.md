...
| 维度 | 检查内容 | 严重程度 |
|------|----------|----------|
| 布局结构 | 元素排列、层级关系、区域划分 | P1 |
| 间距 | 元素间距、内外边距 | P2~P3（按偏差程度判定） |
| 颜色 | 主色、辅色、文字色、背景色 | P2~P3（按偏差程度判定） |
| 字体 | 字族、字号、字重 | P2~P3（按偏差程度判定） |
| 交互状态 | hover/active/disabled/error 状态 | P1 |
| 响应式 | 不同断点下的布局变化 | P2~P3（按偏差程度判定） |
