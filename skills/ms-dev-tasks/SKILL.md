...
> design_context schema 定义见 [prd/references/design-context.md](../ms-prd/references/design-context.md)
...
- [ ] 任务编号格式：`T-XX`（顺序编号）；取当前最大值按 [`id/scan-word-boundary`](../_shared/constraints.md)——⛔ 裸 `grep -o 'T-[0-9]+'` 会把 `UT-001` 里的 `T-001` 当成任务编号
